...
Project-level skills installed from verified upstream sources.
...
- Anthropic's `claude-plugins-official` marketplace is recorded under `.codex/plugins/claude-plugins-official/` as an upstream registry source.
