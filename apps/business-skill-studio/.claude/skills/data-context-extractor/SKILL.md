...
### Step 4: Generate, Review, and Install Separately

1. Copy the uploaded skill into a new isolated output directory outside the loaded `.claude/skills` tree
2. Add the new reference file only in that output directory
3. Update the copied SKILL.md's "Knowledge Base Navigation" section to include the new domain
4. Repackage and present the generated output for review
5. Never modify the currently loaded skill tree at runtime; installation requires a separate, explicit, reviewed copy step
