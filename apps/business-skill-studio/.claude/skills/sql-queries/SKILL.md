...
### PostgreSQL Analytical Examples

The following cohort-retention and funnel examples use PostgreSQL syntax, including `DATE_TRUNC`, PostgreSQL interval literals, and `CURRENT_DATE` arithmetic. Translate them before using another warehouse dialect.
